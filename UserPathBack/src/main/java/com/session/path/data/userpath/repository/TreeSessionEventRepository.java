 ...
 * @date 2023/02/25
 */
public interface TreeSessionEventRepository extends JpaRepository<SessionEventEntity, Integer> {
    ...
    @Transactional
    @Query(value =
            "select concat(f_event_from,'_&_',md5(path_from)) as f_event_from,concat(f_event_to,'_&_',md5(path_to)) as"
            + " f_event_to,event_session,event_user,event_pv from "
    ...
    List<Map<String, Object>> getTreeSessionEventEntity(
    ...
    @Transactional
    @Query(value =
            "select concat(f_category_from,'_&_',md5(path_from)) as f_category_from,"
            + " concat(f_category_to,'_&_',md5(path_to)) as f_category_to,category_session,"
            + " category_user,category_pv from"
    ...
    List<Map<String, Object>> getTreeSessionCategoryEntity(
            String fUserSceneVersionId, int fMakeVersionId, String fCategoryFrom,
    ...
    @Query(value = "select concat(f_subcategory_from,'_&_',md5(path_from)) as f_subcategory_from,"
            + " concat(f_subcategory_to,'_&_',md5(path_to)) as f_subcategory_to,subcategory_session,"
            + " subcategory_user,subcategory_pv from "
    ...
    List<Map<String, Object>> getTreeSessionSubcategoryEntity(
            String fUserSceneVersionId, int fMakeVersionId, String fCategoryFrom,
            String fSubcategoryFrom, int fromLayer, int toLayer, int fSessionNumStart, String fCategory,
            String fSubcategory, int fSessionNumEnd,
            int fUserNumStart,int fUserNumEnd,
            int fPVNumStart,int fPVNumEnd,
