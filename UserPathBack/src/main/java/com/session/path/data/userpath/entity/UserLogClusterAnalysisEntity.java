...
/**
 * @ClassName UserLogClusterAnalysisEntity
 * @Description 用户日志聚类分析表
 * @Author author
 * @Date 2023/03/04 18:00
 * @Version 1.0
 **/
@Entity
@Table(name = "t_user_log_cluster_analysis")
@Data
@DynamicUpdate
public class UserLogClusterAnalysisEntity {
    ...
    private String fLabel; //'分类标签'
    private String fX; //'x坐标'
    private String fY; //'y坐标'
    private int fIsCenter; //'f_is_center'
