...
/**
 * @ClassName LogEventSessionDistributeEntity
 * @Description session分布计算
 * @Author author
 * @Date 2023/02/11 18:00
 * @Version 1.0
 **/
@Entity
@Table(name = "t_user_log_event_session_distribute")
@Data
@DynamicUpdate
public class LogEventSessionDistributeEntity {
    ...
    private int fSessionPv25p; //'f_session_pv_25p'
    private int fSessionPv50p; //'f_session_pv_50p'
    private int fSessionPv75p; //'f_session_pv_75p'
